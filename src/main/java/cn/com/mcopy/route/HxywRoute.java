...
/**
 * Created by ucenter on 2016/11/18.
 */
@Component
public class HxywRoute {
    ...
    private Logger logger = LoggerFactory.getLogger(HxywRoute.class);

    @PostConstruct
    public void initHxyw(){
        get("/hxyw",(request,response)->{
            //查看是否有子菜单
            List<Menu> menus = menusService.querySecondMenu("核心业务");
            if(menus!=null && !menus.isEmpty()){
                ...
                return new ModelAndView(model,"pc/hxywtemplate.ftl");
            }

        },new FreeMarkerEngine());

        get("/hxyw/:secondmenu",(request,response)->{
            ...
            return new ModelAndView(map,"pc/hxywtemplate.ftl");
        },new FreeMarkerEngine());
    }
}
