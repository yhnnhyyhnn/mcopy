...
<head>
    ...
    <script type="text/javascript" src="/local/tabs.js"></script>
...
<div class="row">
    ...
    <div class="table-responsive">
        ...
        <tr>
            <th w_index="TAB_ID" width="15%;">ID</th>
            <th w_index="TITLE" width="30%;">标题</th>
            <th w_index="MENUNAME" w_align="left" width="30%;">所属菜单</th>
            <th w_index="SORT" w_align="left" width="25%;">排序</th>
        </tr>
        </table>
    </div>
</div>
        ...
        <form class="form-horizontal" id="dataForm" role="form">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="myModalLabel">TAB维护</h5>
                </div>
                <input type="hidden" id="TAB_ID1"/>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">标题：</label>
                        <div class="col-sm-10">
                            <input type="text" id="TITLE1" name="TITLE1" placeholder="标题"
                                   class="col-xs-12 col-sm-12"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">所屬菜单：</label>
                        <div class="col-sm-10">
                            <select class="form-control" id="MENUNAME1" name="MENUNAME1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="SORT1" name="SORT1" placeholder="排序" class="col-xs-12 col-sm-12"/>
                        </div>
                    </div>
