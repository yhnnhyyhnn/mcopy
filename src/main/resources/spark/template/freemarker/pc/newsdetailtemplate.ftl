...
<head>
    ...
    <link rel="stylesheet" href="/out/css/info.css" />
    <!--<script type="text/javascript" src="/out/js/jquery-1.7.2.min.js"></script>-->
    <script type="text/javascript" src="/thirdplugins/assets/js/jquery-1.10.2.min.js"></script>
    ...
    <div class="contain">
        ...
        <div class="right">
            <div class="info_right">
                <div class="info_1">
                    <a class="a1" href="/gywm">关于我们</a> -> <a href="/xwzx">新闻中心</a>
                </div>

                <div class="info_2">${news.TITLE}</div>

                <div class="info_3">
                    <div class="info_3_1">
                        <div class="info_3_2">
                            <span>${news.CREATEDATE?string("yyyy-MM-dd")}</span><span>浏览：${news.READCOUNT}</span>
                        </div>
                    </div>
                </div>
                <div class="info_line">
                ...
                <div class="info_content">${news.CONTENT}</div>
            </div>
